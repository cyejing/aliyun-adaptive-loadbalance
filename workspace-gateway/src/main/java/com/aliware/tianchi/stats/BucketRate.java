...
public class BucketRate {
    private final AtomicInteger maxBucket = new AtomicInteger(Integer.MAX_VALUE);
    private final AtomicInteger lastBucket = new AtomicInteger(Integer.MAX_VALUE);
    private final AtomicInteger currentBucket = new AtomicInteger(Integer.MAX_VALUE);
    ...
    private void checkAndResetWindow() {
        ...
        if(threshold < now) {
            ...
            currentBucket.set(Integer.MAX_VALUE);
